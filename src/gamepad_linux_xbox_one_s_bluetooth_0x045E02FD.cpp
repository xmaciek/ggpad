...
constexpr static const MapTable D045E02FD[] = {
    ...
    , { EV_ABS, 0x0002, 0, 0xFFFF, ConversionType::Analog, Gamepad::RX, Gamepad::unknown, -127, 127 }
    , { EV_ABS, 0x0005, 0, 0xFFFF, ConversionType::Analog, Gamepad::RY, Gamepad::unknown, 127, -127 }
    , { EV_ABS, 0x000A, 0, 1023, ConversionType::Analog, Gamepad::L2, Gamepad::unknown, 0, 127 }
    , { EV_ABS, 0x0009, 0, 1023, ConversionType::Analog, Gamepad::R2, Gamepad::unknown, 0, 127 }
